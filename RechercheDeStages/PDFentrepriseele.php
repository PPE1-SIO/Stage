...
$req="SELECT entreprise.NOENT, NOMENT, REPENT, QUALITEREP, ADRUEENT, CPENT, VILLEENT, TELENT FROM entreprise LEFT JOIN testeleve  ON entreprise.NOENT = testeleve.NOENT  LEFT JOIN etudiant  ON etudiant.noetud = testeleve.noetud  WHERE MELETUD = '$Pseudo'";
